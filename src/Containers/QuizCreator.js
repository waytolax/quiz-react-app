...
import {createControl, validate, validateForm} from '../Components/formFramework'
import {createQuizQuestion, finishCreateQuiz} from '../redux/actions/createQuizActions';
            ...
            <Wrapper>
                <div>
                    ...
                    <form onSubmit={this.submitHandler}>
                        ...
                        <Select
                            label={'Выберите правильный ответ'} value={this.state.rightAnswerId} onChange={this.selectChangeHandler}
                            options={[
                                {
                                    text: 1,
                                    value: 1
